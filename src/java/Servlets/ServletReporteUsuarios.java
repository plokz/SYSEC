...
public class ServletReporteUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletReporteUsuarios.class.getName()).log(Level.SEVERE, null, ex);
        }
        String inicial = request.getParameter("fechaIU");
        String finale = request.getParameter("fechaFU");
...
//                    JasperViewer.viewReport(mostrarReporte);
        ...
        JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("WEB-INF/ReporteUsuarios.jasper"));
